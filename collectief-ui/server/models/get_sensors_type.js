...
async function get_sensors_type(token,res0) {
   ...
   //console.log("today_tmp", today_tmp)
    ...
    [rows, fields] = await con.execute("SELECT DISTINCT sensor_type FROM node_2204036" + num_t + " WHERE timestamp >= '" + x + "'");
...
module.exports = {
    get_sensors_type: get_sensors_type
}
