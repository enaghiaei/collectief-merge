...
async function get_temperature_per_hour_7d(token, res0) {
    ...
    */
    ...
    for (var i = 1; i > 0; i--) {
            ...
            var date = new Date(today_time - (1000 * 60 * 60 * (i + 167)));
            //let date = new Date();
...
module.exports = {
    get_temperature_per_hour_7d: get_temperature_per_hour_7d
}
