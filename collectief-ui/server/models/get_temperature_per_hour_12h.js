...
async function get_temperature_per_hour_12h(token, res0) {
    ...
    */
    ...
    for (var i = 1; i > 0; i--) {
            ...
            var date = new Date(today_time - (1000 * 60 * 60 * (i + 3)));
            //let date = new Date();
...
module.exports = {
    get_temperature_per_hour_12h: get_temperature_per_hour_12h
}
