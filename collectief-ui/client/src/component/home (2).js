                ...
                (result) => {
                    ...
                    for (var key in result.result) {
                        if (result.result[key][0]) {
                            ...
                            console.log(result.result[key][0])
                            if (result.result[key][0]["av_max"] != "null") {
                                data5[i] = {};
                                data5[i].year = result.result[key][0]["range_title"];
                                data5[i].value = parseFloat(result.result[key][0]["av_max"]);
                    ...
                    for (var key in result.result) {
                        if (result.result[key][0]) {
                            ...
                            console.log(result.result[key])
                            console.log(result.result[key][0])
                            if (result.result[key][0]["av"] != "null") {
                                data5[i] = {};
                                data5[i].year = result.result[key][0]["range_title"];
                                data5[i].value = parseFloat(result.result[key][0]["av"]);
                    ...
                    for (var key in result.result) {
                        if (result.result[key][0]) {
                            ...
                            console.log(result.result[key])
                            console.log(result.result[key][0])
                            if (result.result[key][0]["av_min"] != "null") {
                                data5[i] = {};
                                data5[i].year = result.result[key][0]["range_title"];
                                data5[i].value = parseFloat(result.result[key][0]["av_min"]);
                ...
                (result) => {
                    ...
                    for (var key in result.result) {
                        if (result.result[key][0]) {
                            ...
                            if (result.result[key][0]["av"] != "null") {
                                data5[key] = {};
                                data5[key].year = result.result[key][0]["range_title"];
                                data5[key].value = parseFloat(result.result[key][0]["av"]);
    ...
    renderColumnsNew(key2) {
        ...
        return this.state.boxes_new.map(function (o, key) {
            ...
            if (context1.state.boxes_new[key].row === key2) {
                ...
                for (var key3 in x6) {
                    if (context1.state.boxes_new[key].type && context1.state.boxes_new[key].type.value_type && context1.state.boxes_new[key].type.value_type.includes(x6[key3].category2)) {
                ...
                for (var key3 in x5) {
                    if (context1.state.boxes_new[key].type && context1.state.boxes_new[key].type.value_type && context1.state.boxes_new[key].type.value_type.includes(x5[key3].category2)) {
                        x5_new[x5_new.length] = x5[key3]
                    }
                }

                for (var key3 in x7) {
                    if (context1.state.boxes_new[key].type && context1.state.boxes_new[key].type.value_type && context1.state.boxes_new[key].type.value_type.includes(x7[key3].category2)) {
                        x7_new[x7_new.length] = x7[key3]
                    }
                }

                for (var key3 in x8) {
                    if (context1.state.boxes_new[key].type && context1.state.boxes_new[key].type.value_type && context1.state.boxes_new[key].type.value_type.includes(x8[key3].category2)) {
            ...
            <div className="main_panel">
                <div className="container_main">
                    ...
                    <div className="container_c6">
                            <div class="row">
                                <div style={{ "text-align": "right", "position": "relative", "top": "-10px" }} className="remove-part d-none p-0 pt-0 pr-1">
                                    <FontAwesomeIcon onClick={(event) => this.openModal3(3)} style={{ "color":"gray","cursor": "pointer", "width": "20px", "height": "20px" }} icon={faEdit} className="arrow pl-2" />
                                    <FontAwesomeIcon onClick={(event) => this.removeModal3(3)} style={{ "color":"gray","cursor": "pointer", "width": "20px", "height": "20px" }} icon={faWindowClose} className="arrow pl-2" />
                                </div>
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 font-weight-bold">Average of temperature</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        {this.state.temperature} ℃
                                        <div className={this.state.loading3}>
                                            <Spinner2 customText="Loading" />
                                        </div>
                                        <span class="text-success text-sm font-weight-bolder"></span>
                                    </h5>
                ...
                <div className="container_main mt-3 pb-5 remove-part d-none">
                    <div className="container_c0 text-center" style={{ "min-height" : "15vh"}}>
                        <FontAwesomeIcon onClick={(event) => this.openModal()} icon={faPlusSquare} className="arrow2" style={{"color":"black","height":"100px",width:"100px"}} />
                    </div>
                </div>
                ...
                <div>
                    ...
                    >
                        ...
                        <div className="m-2">
                            ...
                            <input id="nboxes" type="text" className="mr-4" style={{ border: "1px solid black", "border-radius": "5px" }} size="4"/>
                    ...
                    >
                        ...
                        <div className="m-2">
                            ...
                            <div style={{ "text-align": "center", "border-top": "1px solid gray" }} className="pt-4">
                                <button  style={{ "padding": "10px", "padding-left": "20px", "padding-right": "20px", "border-radius": "7px", "background-color":"rgb(79, 84, 241)","color":"white","border":"0px" , "font-weight" : "bold" }} onClick={(event) => this.addItem()} >
                                    Add
                                </button>
                            </div>
