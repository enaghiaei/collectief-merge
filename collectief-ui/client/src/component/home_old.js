...
import { faAdd, faMinus, faGear, faTemperature0, faPowerOff, faArrowRight, faArrowLeft, faInfo, faCircleInfo, faInfoCircle, faPlusSquare, faClose, faCheck, faTrashAlt, faPlusCircle, faPlus, faEdit, faPenClip, faPen, faWindowClose, faSun, faWind, faLocation, faLocationPin, faMapLocationDot } from '@fortawesome/free-solid-svg-icons';
...
class Home extends React.Component {
   ...
   /* xxxx() {
    ...
    temperature_per_hour_sensor() {
        ...
        //cookies.set('token', result.token, { path: '/' });
       //console.log("cookies=" + cookies.get('token'));
        return fetch('http://' + global.config.vals.root.ip + ':3002/temperature_per_hour_sensor', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    renderWeatherPerDay() {
        ...
        return (
            <div>
                <div className="weather_day_title_h p-2">
                    Quantity
                </div>
                <div className="weather_day_value_h p-2">
                    Value
                </div>
                <div className="newline"></div>
                                    ...
                                    <div class="numbers">
                                        ...
                                        <div className="serials d-none" style={{ position: "relative" }}>
                                            <div className="serials_detail" style={{ position: "absolute", background: "white", "z-index": "900", "width": "350px", "border": "1px solid #ddd", "border-radius": "12px", "padding": "10px" }}>
                                                ...
                                                <div className="serials_detail3" style={{ "text-align": "left", "position": "relative", "left": "-20px", "top": "-8px" }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        <h5 class="font-weight-bolder mb-0">
                                            {this.state.sensor_location_cunt}
                                            <div className={this.state.loading1}>
                                                <Spinner2 customText="Loading" />
                                            </div>
                                            <span class="text-success text-sm font-weight-bolder"></span>
                                        </h5>
                                        <div className="serials_location d-none" style={{ position: "relative" }}>
                                            <div className="serials_detail" style={{ position: "absolute", background: "white", "z-index": "900", "width": "350px", "border": "1px solid #ddd", "border-radius": "12px", "padding": "10px" }}>
                                                <div className="serials_location_detail1">
                                                    {this.list_locations()}
                                                </div>
                                                <div className="serials_location_detail3" style={{ "text-align": "left", "position": "relative", "left": "-20px", "top": "-8px" }}>
                                                    <FontAwesomeIcon onClick={(event) => this.show_sensors1_location()} icon={faArrowLeft} className="arrow ml-3" style={{ "font-weight": "bold", "color": "black", "cursor": "pointer", "font-size": "24px" }} />
                                                </div>
                                                <div className="serials_location_detail2">
                                ...
                                <div class="col-4 text-end">
                                    <div class="icon icon-shape bg-gr-primary shadow text-center border-radius-md" onClick={(event) => this.show_sensors_location()}>
                                        <FontAwesomeIcon onClick={(event) => this.show_sensors1_location()} icon={faInfoCircle} className="arrow2" />
                                    </div>
                                </div>
                            </div>
                        </div>
