...
class Locations extends React.Component {
    ...
    render() {
        //
        //<div>
        //    <iframe src="https://onedrive.live.com/embed?cid=A739990700C84BC8&resid=A739990700C84BC8%211156&authkey=AEPr9kAVmjQiu1A&em=2" width="402" height="346" frameborder="0" scrolling="no"></iframe>
        //</div>
                    ...
                    <div className="main_info">
                        <div className="text-center" style={{ "vertical-align": "middle" }}>
                            ...
                            <div className="text-left mb-3">
                                ...
                                <button value="" id="building_b" onClick={(event) => this.showBuildings()} className="main_header_button inline-table m-2 d-none"><FontAwesomeIcon icon={faEye} className="icon-white inline-table" style={{ "padding-right": "8px" }} /> Buldings </button>
                                <button value="" id="unit_b" onClick={(event) => this.showUnits()} className="main_header_button inline-table m-2 d-none"><FontAwesomeIcon icon={faEye} className="icon-white inline-table" style={{ "padding-right": "8px" }} /> Units </button>
