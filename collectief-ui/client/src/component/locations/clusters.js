...
class Clusters extends React.Component {
    ...
    get_location() {
        ...
        //cookies.set('token', result.token, { path: '/' });
        console.log("cookies=" + cookies.get('token'));
        return fetch('http://' + global.config.vals.root.ip + ':3002/get_clusters', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
                    ...
                    <div className="main_info">
                        <div className="container_main_l1 text-center" style={{ "vertical-align": "middle" }}>
                            <div className="text-left mb-3">
                                ...
                                <button value="" id="cluster_b" onClick={(event) => this.showClusters()} className="main_header_button inline-table m-2 d-none border_bold"><FontAwesomeIcon icon={faEye} className="icon-white inline-table" style={{ "padding-right": "8px" }} /> Clusters </button>
