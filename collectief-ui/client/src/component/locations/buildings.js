...
let type_values = ["Cluster", "Building", "Unit", "Room"]
class Buildings extends React.Component {
    ...
    get_location() {
        ...
        //cookies.set('token', result.token, { path: '/' });
        console.log("cookies=" + cookies.get('token'));
        return fetch('http://' + global.config.vals.root.ip + ':3002/get_buildings', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
                    ...
                    <div className="main_info">
                        <div className="container_main_l1 text-center" style={{ "vertical-align": "middle" }}>
                            <div className="text-left mb-3">
                                ...
                                <button value="" id="building_b" onClick={(event) => this.showBuildings()} className="main_header_button inline-table m-2 border_bold d-none"><FontAwesomeIcon icon={faEye} className="icon-white inline-table" style={{ "padding-right": "8px" }} /> Buldings </button>
