...
class Scheduling extends React.Component {
    ...
    remove_range() {
        ...
        if ((current_remove_id === -1)) {
           ...
           //var parts = x;
            ...
            //console.log(parts);
            parts.splice((this.state.current_day * 7) + current_remove_id,1);
    ...
    setScheduling(event, key) {
        ...
        var x = parts2[current_remove_id];
        alert([x.start, x.end])
        this.setState({
            ...
            if (context1.state.style[key].key === context1.state.current_day) {
               ...
               //console.log(context1.state.style[key])
                if (context1.state.parts[key] && context1.state.parts[key].mode && context1.state.parts[key].mode == 0) {
                    ...
                    return (
                        <div onMouseDown={(event) => context1.movement(event, key)} onMouseUp={context1.movement2} onClick={ (event) => context1.setScheduling(event,key)} style={context1.state.style[key]}>
                            <div style={{ position: "relative", left: context1.state.style[key].temperature_x, top: context1.state.style[key].temperature_y, "font-weight": "bold" }}>
                                {context1.state.style[key].temperature}
                            </div>
                        </div>
        ...
        return (
            <div className="text-left">
                ...
                <div className="icon-row ml-3 mt-2">
                    ...
                    <div className="icon-row-l1 mr-4 pointer" onClick={(event) => this.remove_range(event)}>
                    ...
                    <div className="slider_range slider-parent mt-3">
                        ...
                        <div className="slider-parent_l1 ml-4 mt-2">
                            ...
                            <Slider
                                ...
                                defaultValue={this.state.current_time_range}
                                min={0}
                                max={24}
