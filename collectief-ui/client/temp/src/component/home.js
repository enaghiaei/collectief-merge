...
import { faAdd, faMinus, faGear, faTemperature0, faPowerOff, faArrowRight,faArrowLeft,faInfo, faCircleInfo, faInfoCircle } from '@fortawesome/free-solid-svg-icons';
        ...
        return (
            <div className="main_panel">
                <div className="container_main">
                    ...
                    <div className="container_c6">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Number of sensors</p>
                    ...
                    <div className="container_c6">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Number of locations</p>
                                    <h5 class="font-weight-bolder mb-0">
                    ...
                    <div className="container_c6">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Number of sensors type</p>
                                    <h5 class="font-weight-bolder mb-0">
                    ...
                    <div className="container_c6">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Average of Temperature</p>
                                    <h5 class="font-weight-bolder mb-0">
                ...
                <div className="container_main">
                    ...
                    <div className="container_c4"> <img src={homepic}/></div>
                    <div className="container_c4">
                        <Area {...config4} />
                    </div>
                </div>
